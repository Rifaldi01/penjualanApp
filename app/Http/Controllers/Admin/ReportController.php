    ...
    public function filter(Request $request)
    {
        try {
            ...
            */
            ...
            |--------------------------------------------------------------------------
            |
            | Admin hanya melihat transaksi sesuai divisi user login.
            |
            */
            ...
            */
            ...
            | ==========================================================
            |
            | HANYA SALE DARI DIVISI USER LOGIN
            |
            |--------------------------------------------------------------------------
            */
            ...
            | ==========================================================
            |
            | Tetap menggunakan divisi user login.
            |
            |--------------------------------------------------------------------------
            */
            ...
            */
            ...
            foreach ($sales as $sale) {
                ...
                */
                ...
                $capitalPrice =
                    $capitalItem + $capitalAcc;

                $totalCapital[$sale->id] =
                    $capitalPrice;
                ...
                */
                ...
                $report[] = [
                    ...
                    | PENTING
                    |--------------------------------------------------------------------------
                    | Field yang dikirim bernama "profit"
                    */
