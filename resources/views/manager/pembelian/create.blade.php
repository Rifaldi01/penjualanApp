            ...
            filteredItems.forEach((item) => {
                ...
                <tr>
                    ...
                    <td>
                     ...
                     <td><input type="number" name="items[${itemIndex}][capital_price]" class="form-control" value="${item.capital_price ?? ''}"></td>
                    <td>
        ...
        function displayAccesBykode_msk(kode_msk) {
            ...
            filteredAccessories.forEach((acces) => {
                ...
                <tr>
                   ...
                   <td><input type="number" name="acces[${accesIndex}][capital_price]" class="form-control" value="${acces.capital_price ?? ''}"></td>
                    <td>
