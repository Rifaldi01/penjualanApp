                    ...
                    @forelse($sale->debt as $debt)
                        ...
                        <div class="border rounded p-3 mb-2">
                            ...
                            <div class="text-end mt-2">
                                ...
                                <form action="{{ route('manager.cicilan.payment.destroy', $debt->id) }}"
                                      method="POST"
    ...
    <div class="modal fade"
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-content border-0 radius-15">
                ...
                <form action="{{ route('manager.cicilan.updateSales', $sale->id) }}"
                      method="POST"
                      id="formEditSales">
    ...
    <div class="modal fade"
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-content border-0 radius-15">
                ...
                <form action="{{ route('manager.cicilan.payment', $sale->id) }}"
                      method="POST"
                      id="formPembayaran">
