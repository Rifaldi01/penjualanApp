        ...
        <div class="container">
            <div class="card-header mt-3 mb-3">
                <div class="row">
                    ...
                    <div class="col-sm">
                        <div class="float-end">
                            <a href="{{route('manager.permintaan.create')}}" class="btn btn-dnd bx bx-file" data-bs-toggle="tooltip" data-bs-placement="top" title="Meminta Accessories"></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <table class="table table-bordered table-striped" id="example2">
                    ...
                    @foreach($permintaans as $key => $permintaan)
                        <tr>
                            ...
                            <td>{{ $permintaan->accessories->name }}</td>
                            ...
                            <td>
                                @if(Auth::user()->divisi_id == $permintaan->divisi_id_tujuan && $permintaan->status == 'disetujui')
                                    <!-- Tombol Setujui -->
                                    <form action="{{ route('manager.permintaan.approve', $permintaan->id) }}" method="POST">
                                        @csrf
                                        @method('PUT')
