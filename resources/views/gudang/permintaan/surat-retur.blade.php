    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Surat Retur Barang</h5>
                ...
                <div class="modal-body modal-surat">
                    ...
                    <div class="table-responsive mb-4">
                        <table class="" style="width:100%">
                            ...
                            <tr>
                                ...
                                <th width="1%">:</th>
                                <th>{{$data->divisiAsal->name}}</th>
                                <th width="1%">No</th>
                                <th width="1%" class="text-end">:</th>
                                <th width="1%" class="text-end"
                                    style="border-right-width:0;">{{ $data->kode }}</th>
                            </tr>
                            <tr>
                                <th></th>
                                <th></th>
                                ...
                                <th width="1%" class="text-end">:</th>
                                <th width="1%" style="border-right-width:0;">Retur Permintaan</th>
                            </tr>
                            </thead>
                            <tbody>
                            </tbody>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                            @foreach($data->detailAccessories as $key => $item)
                                <tr>
